...
public class FsmDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.FsmDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.FsmDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				com.example.fsm.FSM model = createInitialModel();
				...
				try {
					modelResource
							.save(com.example.fsm.diagram.part.FsmDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(com.example.fsm.diagram.part.FsmDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static com.example.fsm.FSM createInitialModel() {
	 ...
	 * @generated
	 */
	private static void attachModelToResource(com.example.fsm.FSM model,
			Resource resource) {
