...
import com.example.fsm.diagram.edit.policies.FsmTextSelectionEditPolicy;
import com.example.fsm.diagram.part.FsmVisualIDRegistry;
import com.example.fsm.diagram.providers.FsmElementTypes;
import com.example.fsm.diagram.providers.FsmParserProvider;
		...
		if (parser == null) {
			parser = FsmParserProvider
					.getParser(
							...
							getParserElement(),
							FsmVisualIDRegistry
									.getType(com.example.fsm.diagram.edit.parts.StateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
